...
$room_types_query = $CI->db->select('id, max_occupancy')
    ->from('room_types')
    ->get();
$room_types = $room_types_query->result();

// Initialize counters for total booked and available rooms
...
foreach ($room_types as $room_type) {
    ...
    // Add to total booked and available rooms
    $total_booked_rooms += $booked_rooms;
...
<div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                <div class="panel home-panel-bd bg-gradient-custom-orange d-flex align-items-center justify-content-center">
                    ...
                    <a href="<?php echo site_url('Book_list/more'); ?>" class="statistic-box-link">
<div class="statistic-box text-center text-white">
    <span class="count-number">Booking Area</span> <span class="slight"> </span>
    <div class="lifeord">   
    <p>Total Rem: <span class="available"><?php echo $total_available_rooms; ?></span></p>
            <p>Total Taken: <span class="booked"><?php echo $total_booked_rooms; ?></span></p>
    </div>
</div>

...
$config['base_url'] = $protocol . '127.0.0.1/hotel/';
...
$config['cookie_samesite']  = 'None'; // or 'Lax' or 'Strict'
...
$config['sess_driver'] = 'files'; // Ensure the driver is correct
$config['sess_cookie_name'] = 'ci_session';
$config['sess_expiration'] = 7200; // Duration the session lasts
$config['sess_save_path'] = sys_get_temp_dir(); // Or your server's writable directory
$config['sess_match_ip'] = FALSE;
$config['sess_time_to_update'] = 300;
$config['sess_regenerate_destroy'] = FALSE;
